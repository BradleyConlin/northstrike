...
# Copernicus DSM 30 m tile N43 W080 (covers -80..-79)
DEM_TILE="$SRC/${AREA}_cop30_W080.tif"
if [ ! -f "$DEM_TILE" ]; then
  curl --fail --retry 3 -L -o "$DEM_TILE" \
  "https://copernicus-dem-30m.s3.amazonaws.com/Copernicus_DSM_COG_10_N43_00_W080_00_DEM/Copernicus_DSM_COG_10_N43_00_W080_00_DEM.tif"
fi
...
gdal2tiles.py --xyz -r bilinear -z 12-14 "$VIS" "$TILES/${AREA}_cost8"
gdal2tiles.py --xyz -r bilinear -z 12-14 "$COL" "$TILES/${AREA}_cost_color"
